...
def get_icao_region_name(icao_code):
    """
    Return user-friendly region name for 2-letter ICAO region code.
    """
    return ICAO_REGION_MAPPING.get(icao_code, f"Unknown Region ({icao_code})")


def test_functionality():
    """
    Test function to demonstrate ICAO region functionality with various examples.
    """
    test_codes = ['EP', 'EG', 'EH', 'US', 'DE', 'JP', 'CA', 'AU', 'BG', 'ES']
    
    print("Testing ICAO region codes:")
    print("-" * 40)
    for code in test_codes:
        result = get_icao_region_name(code)
        print(f"{code}: {result}")
